...
## Chuc nang: Quan tri cap nhat quang ba viec lam
...
sequenceDiagram
    ...
    FE->>BE: PATCH /admin/job-promotions/:promotionId
...
**Ma chuc nang:** ADMIN-JOB-PROMOTION-UPDATE-01  
...
Chuc nang cho phep admin chinh sua cau hinh hoac trang thai cua mot promotion hien co. API hien tai duoc trien khai tai `PATCH /admin/job-promotions/:promotionId`.
...
* Body theo validator `updateAdminJobPromotionValidator`.

#### 3.2. Du lieu dau ra (Response Data)
* Thong tin promotion sau cap nhat.
...
* Promotion phai ton tai va body phai qua validator.
...
### 6. Giao dien (UI/UX)
* Form edit can load du lieu chi tiet truoc khi cho sua.
* Sau khi luu nen phan anh thay doi ngay o danh sach.
