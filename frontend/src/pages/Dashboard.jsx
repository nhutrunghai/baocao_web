    ...
    <div className="bg-[#f6f8fb] text-on-surface">
      ...
      <main className="lg:ml-64 min-h-screen p-5">
        <header className="mb-4 flex items-center gap-2">
          ...
          <h1 className="text-[31px] font-semibold text-slate-900">Trang chá»§</h1>
        </header>
        ...
        <section className="mb-4 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
          <h2 className="mb-3 text-lg font-semibold">Thao tÃ¡c nhanh</h2>
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
          <h2 className="mb-3 text-lg font-semibold">Hoáº¡t Ä‘á»™ng gáº§n Ä‘Ã¢y</h2>
